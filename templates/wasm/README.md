...
WASM 環境にはシステムフォントが無い。`0.6.0` から、sabitori は
...
```toml
sabitori = { git = "https://github.com/Mutafika/sabitori", tag = "v0.16.0" }   # HackGen（日本語込み）

sabitori = { git = "https://github.com/Mutafika/sabitori", tag = "v0.16.0",
